   ...
   //    *************  PROCESS DATA  **********************  
    ...
    // data_WPL[5] = Waypoint name
     ...
     for (int i = 0; i< Number_of_waypoints; i++) 
     {
       ...
       if (Waypoint_next == "NO WPT") NEXT_TURN = 0.0;
        ...
        for (int i = 0; i< Number_of_waypoints; i++) 
         {
          ...
          Serial.print( Waypoint_Lat[i]); Serial.print(",  ");  
          Serial.print( Waypoint_Lon[i]); Serial.print(",  ");
          Serial.print(Waypoint_Bearing_From[i],1);  Serial.print(",  ");
          Serial.print(Waypoint_Range_From[i]/6000,1); Serial.print(",  ");
