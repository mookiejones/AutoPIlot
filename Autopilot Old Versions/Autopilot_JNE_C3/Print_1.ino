...
*/
  ...
  if (GPRMC_fix)
   ...
   if(GPRMC_fix) // not including the APB ststus because garmin GPSmap 198C does not support GPAPB will need GPBOD or similar
     {
       lcd.setCursor(0, 0);
       lcd.print("        ");
       lcd.setCursor(0, 0);
   ...
   //}
    ...
    /************* SCREEN = 1 ****************/
      if(Screen == 1)
     {
      ...
      lcd.setCursor(0,2);
      lcd.print("BOD ");
      lcd.print(Bearing_origin_to_destination,0);
