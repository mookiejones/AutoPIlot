 ...
 /********************* CONVERT DATA  **************************/
   ...
   */
    ...
    string1 = data_RMC[10];
    if (Input_Source == 2) N_magvar = 2;
    NEMA_TO_FLOAT(N_magvar); // 2 for Nobeltec, 1 for GPSMAP 60CSX depends on how many decimal data sent
    MagVar = float3;
    ...
    // data_RMC[12] Fix Status 
     if (Input_Source == 2)  data_RMC[12] = "D"; // NOBELTEC does not send data for data_APB[15]
...
/********************* PRINT RMC **************************************************/  
     ...
     void PRINT_RMC()
   {
                 ...
                 Serial.println(Lat_current,4);
                 
                 Serial.print("Lat N/S: ");
                 Serial.println(data_RMC[4]);
                 
                 Serial.print("Longitude: ");
                 Serial.println(Lon_current,4);
